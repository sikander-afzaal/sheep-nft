    ...
    <div className={styles.wrapper}>
      <div className="container-wrapper-2 py-100px padding-0">
        ...
        <div className={styles.cards}>
          <Card
            title="Foster an amazing community that serves as a source of positivity to uplift each other as true pals.
            "
          ...
          />
          <div className="text-center">
            <h1 className="text-center fs-32px black weight-4 mb-30px">
              Provide a supportive environment to aspiring artists and
              developers in the world of WEB
              <span
                style={{
            ...
            <p className={`text-center fs-24px weight-5 font-cream-shoes`}>
              “Our goal is to support and inspire each other to do their
              absolute best.”
            </p>
          </div>
        </div>
